      ...
      <div className="container mx-auto max-w-6xl px-4">
        ...
        <div className="bg-card/90 backdrop-blur-sm border border-border rounded-lg overflow-hidden mb-16">
          <div className="flex items-center justify-between px-5 py-3 border-b border-border bg-background/70">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-primary font-medium">Community Workouts</span>
            </div>
            <div className="text-sm text-muted-foreground">Curated by AI</div>
          </div>

          <div className="p-8 text-center">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              <span className="text-foreground">Explore </span>
              <span className="text-primary">Personalized Fitness Journeys</span>
            </h2>

            <p className="text-lg text-muted-foreground max-w-xl mx-auto mb-10">
              Discover how AI-powered coaching is helping real users achieve their unique health goals.
            </p>
        ...
        <div className="mt-16 text-center">
          ...
          <p className="text-muted-foreground mt-4">
            Join 500+ members using smart programs tailored by our AI
          </p>
        </div>
      </div>
    </div>
